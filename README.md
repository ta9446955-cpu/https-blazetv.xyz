...
**Repository URL**: `https://raw.githubusercontent.com/ta9446955-cpu/https-blazetv.xyz/main/repository.blazetv.zip`

Steps:
1. Go to Settings > Add-ons > Install from zip file
2. Paste the URL above (or download and select the zip)
3. Go to Settings > Add-ons > Install from repository > BlazeTv Repository
4. Select Video Add-ons > BlazeTv > Install

### 📂 Direct Addon Links
- **Addon Folder**: https://github.com/ta9446955-cpu/https-blazetv.xyz/tree/main/plugin.video.blazetv
- **Repository**: https://github.com/ta9446955-cpu/https-blazetv.xyz/tree/main/repository.blazetv
- **Main Branch**: https://github.com/ta9446955-cpu/https-blazetv.xyz

### 📋 Documentation
- **Installation Guide**: https://github.com/ta9446955-cpu/https-blazetv.xyz/blob/main/INSTALLATION_GUIDE.md
- **Repository Guide**: https://github.com/ta9446955-cpu/https-blazetv.xyz/blob/main/repository.blazetv/README.md
- **Changelog**: https://github.com/ta9446955-cpu/https-blazetv.xyz/blob/main/plugin.video.blazetv/changelog.txt

### 🐛 Support
- **Issues & Help**: https://github.com/ta9446955-cpu/https-blazetv.xyz/issues
...
### Method 1: From Repository (Easiest)
1. Download repository: `https://raw.githubusercontent.com/ta9446955-cpu/https-blazetv.xyz/main/repository.blazetv.zip`
2. Settings > Add-ons > Install from zip file
3. Settings > Add-ons > Install from repository > BlazeTv Repository > Video Add-ons > BlazeTv > Install

### Method 2: Direct Installation
1. Download: https://github.com/ta9446955-cpu/https-blazetv.xyz/tree/main/plugin.video.blazetv
2. Extract `plugin.video.blazetv` folder to Kodi addons directory
3. Restart Kodi

**See [INSTALLATION_GUIDE.md](https://github.com/ta9446955-cpu/https-blazetv.xyz/blob/main/INSTALLATION_GUIDE.md) for detailed steps**
...
- Ensure "Unknown sources" is enabled in Kodi settings
- Check your internet connection
...
- **Installation Help**: https://github.com/ta9446955-cpu/https-blazetv.xyz/blob/main/INSTALLATION_GUIDE.md
